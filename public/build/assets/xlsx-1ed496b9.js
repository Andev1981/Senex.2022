...
function $t(e, t, r) {
  for (
    var n = e < 0 ? -1 : 1,
      ...
      p = Math.floor(a);
    l < t &&
    ((p = Math.floor(a)), (f = p * s + i), (c = p * l + o), !(a - p < 5e-8));
...
function Zn(e, t) {
  var r = e.getTime();
  return (
    t ? (r -= 1461 * 24 * 60 * 60 * 1e3) : e >= rs && (r += 24 * 60 * 60 * 1e3),
    (r - (es + (e.getTimezoneOffset() - Jn.getTimezoneOffset()) * 6e4)) /
      (24 * 60 * 60 * 1e3)
  );
}
function I0(e) {
...
function fr(e, t, r) {
  ...
  if ((i = t.match(/^#,##0\.([#0]*0)$/)))
    return r < 0
      ? "-" + fr(e, t, -r)
      : Nr("" + (Math.floor(r) + us(r, i[1].length))) +
          "." +
    ...
    switch ((f = e.charAt(s))) {
      ...
      case "b":
        if (e.charAt(s + 1) === "1" || e.charAt(s + 1) === "2") {
          if (l == null && ((l = bt(t, r, e.charAt(s + 1) === "2")), l == null))
            return "";
...
var Es = (function () {
  ...
  _e = (function () {
    ...
    function v(h, g) {
      for (var d = Math.ceil(h.length / g) - 1, m = [], T = 1; T < d; ++T)
        m[T - 1] = h.slice(T * g, (T + 1) * g);
      return (m[d - 1] = h.slice(d * g)), m;
    }
    function E(h, g, d) {
      for (
        var m = 0, T = 0, w = 0, I = 0, U = 0, D = d.length, N = [], k = [];
        m < D;
        ++m
      )
        (N[m] = k[m] = m), (g[m] = d[m]);
      for (; U < k.length; ++U)
        (m = k[U]),
          ...
          T !== -1 &&
            m != N[m] &&
            ((N[T] = N[m]), k.lastIndexOf(T) < U && k.push(T)),
          w !== -1 &&
            m != N[m] &&
    ...
    function u(h, g, d) {
      for (var m = h.start, T = h.size, w = [], I = m; d && T > 0 && I >= 0; )
        w.push(g.slice(I * K, I * K + K)), (T -= K), (I = Hr(d, I * 4));
    ...
    function V(h, g) {
      ...
      var U = !w.match(Ut);
      for (
        w = w.replace(mt, ""), U && (w = w.replace(Ut, "!")), I = 0;
        I < d.length;
        ++I
      )
        if (
          (U ? d[I].replace(Ut, "!") : d[I]).replace(mt, "") == w ||
          (U ? m[I].replace(Ut, "!") : m[I]).replace(mt, "") == w
        )
      ...
      for (
        ...
        for (;;) {
          ...
          if (((d += X & 15), (X >>>= 4), !((X >>> 8) & 255))) T[w++] = X;
            ...
            for (
              z > 0 && ((Q += sr(h, d, z)), (d += z)),
                !g && I < te && ((T = x0(T, te + 100)), (I = T.length));
              w < te;
    ...
    function ki(h, g) {
      ...
      var d = h.name || "",
        m = d.match(/\.([^\.]+)$/);
      return (m && Mt[m[1]]) ||
        (g && ((m = (d = g).match(/[\.\\]([^\.\\])+$/)), m && Mt[m[1]]))
        ? Mt[m[1]]
        : "application/octet-stream";
    }
    function Pi(h) {
      for (var g = At(h), d = [], m = 0; m < g.length; m += 76)
    ...
    function Gi(h, g, d) {
      ...
      if (m) {
        for (var T = 0; T < h.FileIndex.length; ++T)
          if (h.FileIndex[T] == m)
            return (h.FileIndex[T].name = a(d)), (h.FullPaths[T] = d), !0;
      }
      return !1;
    }
    function Vi(h) {
...
function ca(e) {
  var t = new Date();
  return (
    t.setTime(e * 24 * 60 * 60 * 1e3 + As),
    t.getTimezoneOffset() !== gn &&
      t.setTime(t.getTime() + (t.getTimezoneOffset() - gn) * 6e4),
    t
  );
}
...
function o0(e, t) {
  if (ue && Buffer.isBuffer(e)) {
    if (t) {
      ...
      if (e[1] == 254 && e[2] == 255)
        return Sr(Yi(e.slice(2).toString("binary")));
    }
  ...
  M0 = ue
    ? function (e, t, r) {
        return Buffer.isBuffer(e)
          ? e.toString("utf16le", t, r).replace(mt, "")
          : Fn(e, t, r);
      }
    : Fn,
  yn = function (e, t, r) {
      ...
      for (r = "", l = this.l, o = 0; o < e; ++o) {
        if (this.lens && this.lens.indexOf(l) !== -1)
          return (
            (s = rt(this, l)),
            (this.l = l + 1),
            (f = _t.call(this, e - o, s ? "dbcs-cont" : "sbcs-cont")),
            i.join("") + f
          );
      ...
      switch (e) {
        ...
        case -4:
          return t === "i" || !(this[this.l + 3] & 128)
            ? ((n = (e > 0 ? Hr : Us)(this, this.l)), (this.l += 4), n)
...
function Et(e, t) {
  ...
  var r = me(e);
  return (
    !e.cRel && e.cRel != null && (r = Ks(r)),
    !e.rRel && e.rRel != null && (r = Vs(r)),
    r
  );
}
function T0(e, t) {
...
function b0(e) {
  for (var t = zs(e), r = 0, n = 0; n !== t.length; ++n)
...
function Or(e, t, r) {
  return e == null || e.t == null || e.t == "z"
    ...
    : (e.t == "d" && !e.z && r && r.dateNF && (e.z = r.dateNF),
      e.t == "e" ? Nt[e.v] || e.v : t == null ? Dn(e, e.v) : Dn(e, t));
}
function zr(e, t) {
      ...
      for (var x = 0; x != t[p].length; ++x)
        if (!(typeof t[p][x] > "u")) {
          ...
          if (
            ...
            (Array.isArray(v.v) && ((v.f = t[p][x][1]), (v.v = v.v[0])),
            v.v === null)
          )
            if (v.f) v.t = "n";
            ...
            typeof v.v == "number"
              ...
              ? ((v.z = n.dateNF || ye[14]),
                n.cellDates
                  ? ((v.t = "d"), (v.w = kr(v.z, Ze(v.v))))
                  : ((v.t = "n"), (v.v = Ze(v.v)), (v.w = kr(v.z, v.v))))
              : (v.t = "s");
          if (a)
            i[E] || (i[E] = []),
...
function Da(e) {
  ...
  e.l += 4;
  var a =
    n === 0 ? Jt([0, 0, 0, 0, t[0] & 252, t[1], t[2], t[3]], 0) : Hr(t, 0) >> 2;
  return r ? a / 100 : a;
}
function Ra(e, t) {
  t == null && (t = B(4));
...
function Ln(e, t, r) {
  ...
  if (
    ...
    for (c[0].write_shift(4, e.length), f = 0; f < e.length; ++f) {
      var p = e[f][0];
      for (
        o = B(4 + 4 + 2 * (p.length + 1) + (p.length % 2 ? 0 : 2)),
          o.write_shift(4, f + 2),
...
var rl = (function () {
    ...
    function r(f, o) {
      ...
      for (
        var y = [],
          M = {},
          j = Math.min(c.length, p == 2 ? 521 : _ - 10 - (v ? 264 : 0)),
          ee = E ? 32 : 11;
        c.l < j && c[c.l] != 13;
        ...
        for (++c.l, l[++C] = [], b = 0, b = 0; b != y.length; ++b) {
          ...
          switch (y[b].type) {
            ...
            case "M":
              if (!x)
                throw new Error(
                  "DBF Unexpected MEMO for type " + p.toString(16)
                );
              l[C][b] =
    ...
    function s(f, o) {
      var l = o || {};
      if ((+l.codepage >= 0 && St(+l.codepage), l.type == "string"))
          ...
          for (var E = c.s.c; E <= c.e.c; ++E) {
            ...
            switch (p.t) {
              ...
              case "s":
                ...
                break;
              case "d":
                p.w || (p.w = kr(p.z || ye[14], Ze(je(p.v)))),
                  s(l, 0, p.w, "V");
                break;
              default:
                s(l, 1, 0, "");
...
`);
  ...
  al = (function () {
    ...
    function a(c) {
      for (var p = {}, x = !1, v = 0, E = 0; v < c.length; ++v)
        (E = c.charCodeAt(v)) == 34
          ? (x = !x)
          : !x && E in r && (p[E] = (p[E] || 0) + 1);
      E = [];
      for (v in p)
...
`
      ...
      function G() {
        ...
        if (
          ...
          L &&
            V.match(L) &&
            ((V = Ts(V, x.dateNF, V.match(L) || [])), (re = 1)),
            x.cellDates
              ? ((K.t = "d"), (K.v = je(V, re)))
      ...
      return (
        v[0] == 239 && v[1] == 187 && v[2] == 191
          ...
          : p.type == "binary" &&
            typeof Wr < "u" &&
            p.codepage &&
            (x = Wr.utils.decode(p.codepage, Wr.utils.encode(28591, x))),
        x.slice(0, 19) == "socialcalc:version:"
          ? Ya.to_sheet(p.type == "string" ? x : gt(x), p)
          : s(x, p)
      );
    }
    function o(c, p) {
    ...
    function l(c) {
      for (
        var p = [], x = Ee(c["!ref"]), v, E = Array.isArray(c), u = x.s.r;
        u <= x.e.r;
        ++u
      ) {
...
`);
  ...
  bn = (function () {
    ...
    function n(S, P) {
      var F = P || {};
      if ((+F.codepage >= 0 && St(+F.codepage), F.type == "string"))
  ...
  for (var n = 0; n != e.length; ++n)
    if (e[n] != null) {
      ...
      a.r
        ...
        : ((i += "<t"),
          a.t || (a.t = ""),
          a.t.match(il) && (i += ' xml:space="preserve"'),
          (i += ">" + de(a.t) + "</t>")),
        (i += "</si>"),
        (r[r.length] = i);
    }
...
function X0(e) {
  e.width
    ...
    : typeof e.wch == "number" &&
      ((e.width = D0(e.wch)), (e.wpx = e0(e.width)), (e.MDW = yr)),
...
function gl(e, t, r) {
  ...
  switch (
    (o > 0 && (n.charset = o), e.l++, (n.color = nf(e)), e.read_shift(1))
  ) {
    case 1:
      n.scheme = "major";
      break;
...
function Il(e) {
  var t = 1;
  W(e, 626, pr(t)),
    W(e, 47, Qa({ numFmtId: 0, fontId: 0, fillId: 0, borderId: 0 }, 65535)),
    W(e, 627);
}
function Nl(e, t) {
  W(e, 617, pr(t.length)),
...
function kl(e) {
  var t = 1;
  W(e, 619, pr(t)),
    W(e, 48, Fl({ xfId: 0, builtinId: 0, name: "Normal" })),
    W(e, 620);
}
function Pl(e) {
  var t = 0;
...
function Bo(e, t, r) {
  ...
  for (var i = 0, s = []; i != n && (s[i] = []); ++i)
    for (var f = 0; f != a; ++f) s[i][f] = Lo(e, r.biff);
  return s;
}
function Uo(e, t, r) {
...
function pc(e, t, r) {
  for (var n = e.l + t, a, i, s = []; n != e.l; )
    (t = n - e.l),
      (i = e[e.l]),
      (a = Vn[i] || Vn[hc[i]]),
      (i === 24 || i === 25) && (a = (i === 24 ? uc : xc)[e[e.l + 1]]),
...
var Ec = c0,
  ...
  Ac = {
    ...
    396: "SELECT.ALL",
    397: "UNGROUP.SHEETS",
    398: "subtotal_clp.CREATE",
    399: "subtotal_clp.REMOVE",
    400: "RENAME.OBJECT",
    412: "WORKBOOK.SCROLL",
    413: "WORKBOOK.NEXT",
    414: "WORKBOOK.PREV",
...
function $0(e, t, r) {
  ...
  if (r) {
    if (wt ? r.has(t) : Object.prototype.hasOwnProperty.call(r, t)) {
      for (var i = wt ? r.get(t) : r[t]; n < i.length; ++n)
...
function xi(e, t, r, n) {
  ...
  return (
    o["!links"].length > 0 &&
      ...
      o["!links"].forEach(function (u) {
        u[1].Target &&
          ((v = { ref: u[0] }),
          u[1].Target.charAt(0) != "#" &&
            ((E = pe(n, -1, de(u[1].Target).replace(/#.*$/, ""), he.HLINK)),
            (v["r:id"] = "rId" + E)),
          (x = u[1].Target.indexOf("#")) > -1 &&
            (v.location = de(u[1].Target.slice(x + 1))),
    ...
    p.length > 0 &&
      ((E = pe(n, -1, "../drawings/drawing" + (e + 1) + ".xml", he.DRAW)),
      (a[a.length] = Y("drawing", null, { "r:id": "rId" + E })),
      (o["!drawing"] = p)),
    o["!comments"].length > 0 &&
      ((E = pe(n, -1, "../drawings/vmlDrawing" + (e + 1) + ".vml", he.VML)),
      ...
      return (
        a.bookSST
          ? ((f = $0(a.Strings, t.v, a.revStrings)),
            (o.t = "s"),
            (o.v = f),
            s ? W(e, 18, o1(t, o)) : W(e, 7, f1(t, o)))
          : ((o.t = "str"), s ? W(e, 17, w1(t, o)) : W(e, 6, T1(t, o))),
        !0
      );
    case "n":
      return (
...
function nh(e) {
  return !e.Workbook || !e.Workbook.WBProps
    ? "false"
    : Ns(e.Workbook.WBProps.date1904)
    ? "true"
    : "false";
}
var ah = "][*?/\\".split("");
...
function sh(e) {
  ...
  for (var r = 0; r < e.SheetNames.length; ++r)
    Oc(e.Sheets[e.SheetNames[r]], e.SheetNames[r], r);
}
function di(e) {
  var t = [Re];
...
function dh(e, t) {
  ...
  return (
    W(r, 131),
    W(r, 128, xh()),
    W(r, 153, ch((e.Workbook && e.Workbook.WBProps) || null)),
    ph(r, e),
    uh(r, e),
    W(r, 132),
    r.end()
...
function Sh(e, t) {
  ...
  return (
    ...
    e.Custprops && r.push(_f(e.Props, e.Custprops)),
    r.join("")
  );
}
function Ah() {
...
function Ph(e, t) {
  ...
  for (var n = 0; n < e.SheetNames.length; ++n)
    r.push(Y("Worksheet", kh(n, t, e), { "ss:Name": de(e.SheetNames[n]) }));
  return (
    (r[2] = Fh(e, t)),
    (r[3] = yh(e)),
    Re +
...
function Vh(e, t) {
  ...
  return (
    ...
    Gh(n, e.Sheets[e.SheetNames[a]], a, r),
    J(n, 10),
    n.end()
  );
}
...
function Zh(e, t, r) {
  ...
  return (
    l && J(n, 574, Lf((s.Views || [])[0])),
    l && (i["!merges"] || []).length && J(n, 229, zf(i["!merges"])),
    l && $h(n, i),
    J(n, 442, Ka(R)),
    l && zh(n, i),
    J(n, 10),
...
function qh(e, t, r) {
  ...
  for (u = 0; u < e.SheetNames.length; ++u) {
    ...
    J(
      v,
      133,
      Nf({ pos: _, hs: O.Hidden || 0, dt: 0, name: e.SheetNames[u] }, r)
    ),
      (_ += t[u].length);
  }
  var R = v.end();
...
`);
      for (var p = 0; p != s.SheetNames.length; ++p)
        o.push(n(s.Sheets[s.SheetNames[p]], s, p));
      return (
        o.push(`    </office:spreadsheet>
`),
        o.push(`  </office:body>
...
function uu(e, t) {
  ...
  for (
    var p = _e.find(l, f[1].location), x = hr(ur(p.content)), v, E = 0;
    E < x.length;
    ++E
  ) {
    var u = x[E];
  ...
  for (
    p = _e.find(l, f[_].location), x = hr(ur(p.content)), E = 0;
    E < x.length;
    ++E
  )
    (u = x[E]), u.id == _ && (v = u);
  for (
    _ = Rr(Ie(v.messages[0].data)[2][0].data),
      p = _e.find(l, f[_].location),
      x = hr(ur(p.content)),
      E = 0;
    E < x.length;
    ++E
  ...
  for (
    ...
    if (p) {
      ...
      v &&
        ...
        p["!legacy"] &&
          E &&
          oe(i, "xl/drawings/vmlDrawing" + f + ".vml", ti(f, p["!comments"])),
        delete p["!comments"],
        delete p["!legacy"];
    }
  ...
  for (var o = !0, l = [], c = "", p = He(r), x = t.s.c; x <= t.e.c; ++x)
    if (n[x]) {
      ...
      if (v == null) c = "";
        ...
        (o = !1),
          (c = "" + (f.rawNumbers && v.t == "n" ? v.v : Or(v, null, f)));
...
function Du(e, t, r, n) {
  ...
  if ((pi(r), e.SheetNames.indexOf(r) >= 0))
...
export { Ai as a, Mu as u, Lu as w };
