    ...
    <div class="flex flex-wrap items-center justify-between">
        ...
        <div class="flex items-center lg:order-2">
          ...
          <!--       <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                    <li>
                        <a href="#" class="block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">My
                            profile</a>
                    </li>
                    <li>
                        <a href="#" class="block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Account
                            settings</a>
                    </li>
                </ul> -->
               <!--  <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                ...
                <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                    <li>
                        ...
                        this.closest('form').submit();" class="block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                {{ __('Cerrar sesión') }}
                            </a>
                        </form>
                    </li>
