<div>
    <button wire:click="$set('openvalores','')" class="flex items-center px-2 py-1 mx-2 text-sm font-medium text-center text-white bg-green-500 border border-green-200 rounded-lg focus:outline-none hover:bg-green-700 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200" type="button">
