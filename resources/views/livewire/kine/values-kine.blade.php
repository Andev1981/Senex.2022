<div>
    <button wire:click="$set('openvalores','')"
        class="inline-flex items-center px-2 py-1 text-sm font-medium text-center text-white bg-green-700 border border-green-200 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 hover:text-primary-700 focus:z-10"
        type="button">
                ...
                <form wire:submit.prevent="save">
                    <div class="grid grid-cols-5 grid-rows-2 gap-4 border-b-2">
                        <div class="col-span-2 text-left">
                            <label class="text-sm font-medium text-gray-900 dark:text-white">Tratamiento</label>
                            <select
                                class="block w-full p-2 mr-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                wire:model.defer="atencionSelected" required>
                        ...
                        <div class="col-span-2 col-start-3">
                            <x-input-field label="Valor" type="number" placeholder="" required
                                wire:model.defer="atencionValor">
            ...
            <table class="w-full mb-4 -mt-16 text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="text-center uppercase bg-white border-b dark:border-gray-700 hover:bg-cyan-50">
                        ...
                        <td>
                            <button wire:click="setValues({{ $apply }})" type="button"
                                class="inline-flex items-center px-2 py-1 my-2 ml-5 text-xs font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Editar</button>
                            @if (auth()->user()->email == 'javt1981@gmail.com')

                            <button wire:click.defer="setValuesDelete({{ $apply }})" type="button"
    ...
    <!-- Modal Eliminar -->
    <div
        class="{{ $openDelApply }} bg-gray-600 bg-opacity-50 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full flex">
        <div class="relative w-full h-full max-w-2xl p-4 md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button type="button" wire:click="$set('openDelApply','hidden')"
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Seguro que desea eliminar al
                        el registro?</h3>
                    @if ($setApplyUser)
                    <button type="button" wire:click="deleteAtencion({{$setApplyUser}})"
                    ...
                    <button wire:click="$set('openDelApply','hidden')" type="button"
