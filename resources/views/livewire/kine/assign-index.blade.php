<div>
    <div class="flex flex-row">
        @if ($status === 1)
            <button wire:click="$set('opendetalles','')"
                class="flex items-center px-2 py-1 mr-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                type="button">
    ...
    <!-- Main modal -->
    <div tabindex="-1" data-modal-placement="top" aria-hidden="true"
        class="{{ $opendetalles }} bg-gray-600 bg-opacity-50  top-0 right-0 left-0 z-50 justify-center items-center  md:h-full  fixed w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
