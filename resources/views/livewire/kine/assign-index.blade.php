                        ...
                        <div class="col-span-2">
                            ...
                            <div>
                                <x-input-field-senex 
                                    ...
                                    placeholder=""
                                    type="text"
                                    wire:model.defer="kine.name">
                                       <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                        fill="none" viewBox="0 0 24 24" stroke="currentColor" class="text-gray-500"  stroke-width="2">
                            ...
                            <div>
                                <x-input-field-senex 
                                    ...
                                    placeholder=""
                                    type="text"
                                    wire:model.defer="kine.last_name">
                                       <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                        fill="none" viewBox="0 0 24 24" stroke="currentColor" class="text-gray-500"  stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            ...
                            <div class="flex items-center pt-5 space-x-4 border-t-1">
                                <button type="submit" wire:loading.remove wire:target="saveKine"
                                ...
                                <div class="flex">
                                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <th scope="col" class="px-6 py-3">ValorCliente</th>
