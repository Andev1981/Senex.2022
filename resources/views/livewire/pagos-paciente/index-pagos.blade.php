            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                @else
                    <div class="p-6 text-center">
                        ...
                        <button type="button" wire:click="deletePaciente()" class="text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">Si,
                            Estoy Seguro</button>
