                            ...
                            <div class="grid gap-4 mb-4 sm:grid-cols-2">                             
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select wire:model.defer="selectedType" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm pl-10 pr-4 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
