<div>
    <div class="items-center space-x-2">
        <button type="button" wire:click="$set('openAtencion','')" class="flex items-center px-2 py-1 text-sm font-medium text-center text-white rounded-lg bg-sky-700 hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-sky-300 dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800">
        ...
        <div class="relative w-full h-full p-4 md:max-w-3xl md:h-auto">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex items-center justify-between pb-4 mb-4 border-b rounded-t sm:mb-5 dark:border-gray-600">
                    ...
                    <button wire:click="$set('openAtencion','hidden')" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 ">
                        <div class="space-y-4 sm:col-span-2 sm:space-y-6">
                            <div class="grid gap-4 mb-4 sm:grid-cols-3">
                                <div>
                                    <x-input-field label="Profesional derivación" name="profesional_derivacion" type="text" wire:model.defer="profesional_derivacion" placeholder="">
                                ...
                                <div>
                                    <x-input-field label="Derivado desde" name="lugar_derivacion" type="text" wire:model.defer="lugar_derivacion" placeholder="">
                                ...
                                <div>
                                    <label for="application_type" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tipo de
                                        Atención</label>
                                    <div class="relative">
                                ...
                                <div>
                                    <label for="doctor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Asignar a
                                        Kine</label>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                ...
                                <div>
                                    <x-input-field label="Valor" name="valor" type="number" wire:model.defer="valor" placeholder="ingrese valor">
                                ...
                                <div>
                                    <x-input-field label="Cantidad de Sesiones" name="sesiones" type="number" wire:model.defer="sesiones" placeholder="cantidad de sesiones">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            ...
                            <div class="space-y-4 sm:col-span- sm:space-y-6">
                                <div>
                                    <label for="documentos" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Si tiene
                                        documentos
                                        ingreselos acá</label>
                                    <div class="flex items-center justify-center w-full">
                                        <label for="dropzone-file" class="flex flex-col items-center justify-center w-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer h-36 bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                ...
                                <div class="grid grid-cols-4 gap-4 mb-4">
                                    ...
                                    <div class="relative p-2 bg-gray-100 rounded-lg sm:w-36 sm:h-36 dark:bg-gray-700">
                                        ...
                                        <label class="absolute ml-5" for="">{{ $documento->getClientOriginalName() }}</label>
                                        @endif
