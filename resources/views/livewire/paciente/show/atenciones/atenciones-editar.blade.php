<div>
    <div class="flex items-center space-x-2">
        <button type="button" wire:click="$set('openAtencion','')"
        ...
        <button type="button" wire:click="$set('openDelAtencion','')"
    ...
    <div
        class="{{ $openAtencion }} bg-gray-600 bg-opacity-50 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center w-full md:inset-0 h-modal md:h-full flex">
        <div class="relative w-full md:max-w-3xl h-full p-4 md:h-auto">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div
                    ...
                    <button wire:click="$set('openAtencion','hidden')" type="button"
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 ">
                        <div class="space-y-4 sm:col-span-2 sm:space-y-6">
                            <div class="grid gap-4 mb-4 sm:grid-cols-3">
                                <div>
                                    <x-input-field label="Profesional derivación" name="profesional_derivacion"
                                        type="text" wire:model.defer="profesional_derivacion" placeholder="">
                                ...
                                <div>
                                    <x-input-field label="Derivado desde" name="lugar_derivacion" type="text"
                                        wire:model.defer="lugar_derivacion" placeholder="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select wire:model.defer="tipo_atencion"
                                ...
                                <div>
                                    <label for="doctor"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Asignar a
                                        Kine</label>
                                    <div class="relative">
                                        <div
                                            class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                ...
                                <div>
                                    <x-input-field label="Valor" name="valor" type="number"
                                        wire:model.defer="valor" placeholder="ingrese valor">
                                ...
                                <div>
                                    <x-input-field label="Cantidad de Sesiones" name="sesiones" type="number"
                                        wire:model.defer="sesiones" placeholder="cantidad de sesiones">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="space-y-4 sm:col-span- sm:space-y-6">
                                <div>
                                    <label for="documentos"
                                        class="block text-sm mb-2 font-medium text-gray-900 dark:text-white">Si tiene
                                        documentos
                                    ...
                                    <div class="flex items-center justify-center w-full">
                                        <label for="dropzone-file"
                                            ...
                                            <input id="dropzone-file" wire:model="documentos" type="file"
                                    ...
                                    <div class="grid grid-cols-4 gap-4 mb-4">
                                        @foreach ($documentos as $documento)
                                            <div
                                                ...
                                                @else
                                                    <img class="w-full h-auto" src="{{ asset('icons/pdf.png') }}"
                                                        alt="imac image">
                                                    <label class="absolute ml-5"
                                                        for="">{{ $documento->getClientOriginalName() }}</label>
                                                @endif
                                                <button type="button"
                                ...
                                <div>
                                    <label for="mensaje"
                                        class="block text-sm font-medium text-gray-900 dark:text-white">Comentario o
                                        detalles</label>
                                    <textarea wire:model.defer="mensaje" rows="4"
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Si tiene algún comentario, ingreselo acá...">
                                    </textarea>
                                </div>
    ...
    {{-- Modal Eliminar --}}
    <div
        class="{{ $openDelAtencion }} bg-gray-600 bg-opacity-50 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full flex">
        <div class="relative w-full h-full max-w-2xl p-4 md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button type="button" wire:click="$set('openDelAtencion','hidden')"
                ...
                <div class="p-6 text-center">
                    ...
                    <button type="button" wire:click="delete"
                        ...
                        Estoy Seguro</button>
                    <button wire:click="$set('openDelAtencion','hidden')" type="button"
