<div>
    <div class="flex items-center space-x-2">
        <button type="button" wire:click="$set('openCrearAtencion','')"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 -ml-0.5" fill="none" viewBox="0 0 24 24"
    ...
    <!-- Main modal -->
    <div
        class="{{ $openCrearAtencion }} bg-gray-600 bg-opacity-50 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center w-full md:inset-0 h-modal md:h-full flex">
        <div class="relative w-full md:max-w-3xl h-full p-4 md:h-auto">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div
                    ...
                    <button wire:click="$set('openCrearAtencion','hidden')" type="button"
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 ">
                        <div class="space-y-4 sm:col-span-2 sm:space-y-6">
                            <div class="grid gap-4 mb-4 sm:grid-cols-3">
                                <div>
                                    <x-input-field label="Profesional derivación" type="text"
                                        wire:model.defer="profesional_derivacion"
                                        placeholder="Nombre de doctor que deriva">
                                ...
                                <div>
                                    <x-input-field label="Derivado desde" type="text"
                                        wire:model.defer="lugar_derivacion" placeholder="lugar desde donde es derivado">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <div>
                                    <x-input-field label="Valor" type="number" wire:model.defer="valor"
                                ...
                                <div>
                                    <x-input-field label="Cantidad de Sesiones" type="number"
                                        wire:model.defer="sesiones" placeholder="ej: 12">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
