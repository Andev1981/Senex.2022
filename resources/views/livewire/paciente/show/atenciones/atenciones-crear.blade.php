<div>
    ...
    <!-- Main modal -->
    <div class="{{ $openCrearAtencion }} bg-gray-600 bg-opacity-50 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center w-full md:inset-0 h-modal md:h-full flex">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form wire:submit.prevent="save">
                    <div class="grid gap-4 mb-4 sm:grid-cols-4">
                        <div>
                            <x-input-field label="Profesional que deriva" type="text" wire:model.defer="profesional_derivacion" placeholder="Ingrese nombre">
                        ...
                        <div>
                            <label for="tipo_de_valor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tipo de valor</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                ...
                                <select wire:model.defer="tipo_de_valor" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm pl-10 pr-4 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option selected>-seleccione-</option>
                                    <option value="0">Valor por sesión</option>
                                    <option value="1">Valor por total tratamiento</option>
                                </select>
                            </div>
                            @error('tipo_de_valor')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                        ...
                        <div>
                            <label for="tipo_de_pago" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Forma de Pago</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                        ...
                        <div>
                            <x-input-field label="Valor" type="number" wire:model.defer="valor" placeholder="ej: 120000">
                        ...
                        <div>
                            <x-input-field label="Cantidad de Sesiones" type="number" wire:model.defer="sesiones" placeholder="ej: 12">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
