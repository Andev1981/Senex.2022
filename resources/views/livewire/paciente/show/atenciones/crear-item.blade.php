<div>
    <div class="flex items-center space-x-2 pl-2">
        <button type="button" wire:click="$set('openItemCreate','')" class="flex items-center px-2 py-1 text-xs font-medium text-center text-white rounded-lg bg-sky-700 hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-sky-300 dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800">
