        ...
        <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
            <div class="flex flex-col items-center justify-end md:flex-row md:space-y-0 md:space-x-4">
                <div class="flex justify-end">
                    @livewire('paciente.show.apoderados-crear')
                </div>
            </div>
                            ...
                            <tr class="bg-white border-b dark:border-gray-700 hover:bg-cyan-50">
                                <td class="flex items-center py-2 pl-2 mx-2">
                                    <div class="ml-2 font-medium dark:text-white">
                                        <div class="">{{ $keeper->name }} {{ $keeper->last_name }}</div>
                                        <div class="font-medium">{{ $keeper->email }}</div>
                                        <div class="text-sm text-gray-500 dark:text-gray-400">{{ $paciente->rut }}</div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">{{ $paciente->select_option }}</td>
                                <td class="px-6 py-4">{{ $paciente->select_option }}</td>
