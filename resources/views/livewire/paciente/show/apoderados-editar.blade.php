            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form wire:submit.prevent="save">
                    <div class="grid gap-4 mb-4 sm:grid-cols-3">
                        <div>
                            <x-input-field label="Nombre" name="first_name" type="text"
                                wire:model.defer="keeper.name" placeholder="ingrese nombre">
                        ...
                        <div>
                            <x-input-field label="Apellido" name="last_name" type="text"
                                wire:model.defer="keeper.last_name" placeholder="ingrese apellido">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div>
                            <x-input-field label="Correo" name="email" type="email" wire:model.defer="keeper.email"
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <small
                                    class="absolute inset-y-0 right-0 flex pt-2 pr-6 italic text-gray-400 right">{{ strlen($keeper->phone) }}
                                    /9</small>
                                <input wire:model="keeper.phone" type="number"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select id="parentesco" wire:model.defer="keeper.parentesco"
