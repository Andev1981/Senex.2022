            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form wire:submit.prevent="save">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-1 md:grid-cols-3">
                        <div>
                            <x-input-field-required label="Nombre" type="text" wire:model.defer="paciente.name"
                        ...
                        <div>
                            <x-input-field-required label="Apellido" type="text" wire:model.defer="paciente.last_name"
                        ...
                        <div>
                            <x-input-field-required label="Fecha de nacimiento" type="date"
                                wire:model.defer="paciente.birth" placeholder="">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                    class="bi bi-calendar2-plus w-5 h-5 text-gray-500 dark:text-gray-400"
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-1 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input wire:model="paciente.email" type="email"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500 uppercase">
                            </div>
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1" stroke="currentColor" class="w-3 h-3">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <small class="absolute inset-y-0 right-0 flex pt-2 pr-6 italic text-gray-400 right">{{
                                    strlen($paciente->phone) ?? '' }}
                                    /9</small>
                                <input wire:model="paciente.phone" type="text"
                                ...
                                <div class="flex">
                                    ...
                                    <div id="dropdown-search-city"
                                        ...
                                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                            ...
                                            <li>
                                                <button type="button" {{--
                                                    wire:click="$set('selectedRegion', {{ $region->id }})" --}}
                    ...
                    <div class="grid gap-4 mb-2 sm:grid-cols-2">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" wire:model.defer="address.street"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500 uppercase"
                                    placeholder="">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" wire:model.defer="address.number"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500 uppercase"
                    ...
                    <div class="grid grid-cols-3 gap-4 py-4 px-2">
                        ...
                        @livewire('paciente.preguntas',['paciente' => $paciente,'question' =>
