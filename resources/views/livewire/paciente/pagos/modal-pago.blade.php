            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form wire:submit.prevent="save">
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div>
                            <x-input-field label="Fecha de pago" name="pay" type="date" wire:model.defer="pay" placeholder="" class="uppercase">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-1">
                        <label for="" class="mt-4 font-semibold text-slate-900">Sesiones</label>
                            <div class="flex">
                                @foreach ( $items as $singleItem)
                                    <div class="flex-row items-center mb-4 mr-4">
                                        <input id="default-checkbox" type="checkbox" wire:click="selectItem({{$singleItem->id}})" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                            <label for="default-checkbox" class="ml-1 text-sm font-medium text-gray-900 dark:text-gray-300"> {{ \Carbon\Carbon::parse(strtotime($singleItem->fecha_atencion))->format('d/m/Y') }}</label>
                                    </div>
                                @endforeach 
                            </div>
                    </div>
