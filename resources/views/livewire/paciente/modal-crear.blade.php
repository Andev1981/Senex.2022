<div>
  <button wire:click="$set('open','')"
    class="flex items-center text-white bg-sky-700 hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-sky-300 font-medium rounded-lg text-sm px-2 py-1.5 text-center dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800"
    type="button">
      ...
      <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
        ...
        <form wire:submit.prevent="save">
          ...
          <div class="grid gap-4 mb-4 sm:grid-cols-1 md:grid-cols-3">
            ...
            <div>
              <x-input-field-required label="Fecha de nacimiento" type="date" wire:model.defer="fecha_nacimiento"
                placeholder="">
