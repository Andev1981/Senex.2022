        ...
        <div class="relative w-full h-full max-w-3xl p-4 md:h-auto">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form wire:submit.prevent="save">
                    <div class="grid mb-4 sm:grid-cols-2">
                        <div class="mb-4">
                            ...
                            <div class="relative w-16 h-16 overflow-hidden bg-gray-100 rounded-full shadow-xl dark:bg-gray-600">
                                ...
                                @if ($avatar)
                                <img class="w-16 h-16 rounded" src="{{ $avatar->temporaryURL() }}" alt="Large avatar">
                                @else
                                <svg wire:loading.remove wire:target='avatar' class="absolute w-16 h-16 text-gray-400 -left-1" fill="currentColor" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <input class="block mt-2 text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" wire:model="avatar" id="file_input" type="file">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <small class="absolute inset-y-0 right-0 flex pt-2 pr-6 italic text-gray-400 right">{{ strlen($telefono) }}
                                    /9</small>
                                <input wire:model="telefono" type="number" max='9' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-full pl-16 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500">
                            </div>
