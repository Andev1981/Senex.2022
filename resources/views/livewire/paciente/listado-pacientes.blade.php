                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:border-gray-700 hover:bg-cyan-50">
                                <td class="flex items-center py-2 pl-2 mx-2">
                                    @if ($paciente->avatar)
                                    <img class="w-10 h-10 rounded-full shadow-xl" src="{{ asset($paciente->avatar) }}" alt="">
                                    @else
                                    <svg class="w-10 h-10 text-gray-400  rounded-full shadow-xl" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
