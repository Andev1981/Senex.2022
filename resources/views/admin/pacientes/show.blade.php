            ...
            <div class="w-full md:w-9/12 mx-2 h-64">
                ...
                <div class="bg-white p-3 shadow-sm rounded-sm">
                    <div class="w-full mx-auto mt-4  rounded">
                        <a type="button" href="{{ route('step.one', $paciente) }}" class="bg-azul hover:bg-blue-800 mx-auto lg:mx-0 text-white font-bold rounded-full my-2 py-2 px-2 shadow-lg float-right text-sm">Nuevo Tratamiento</a>
                        <!-- Tabs -->
                                                ...
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    ...
                                                    <td class="py-4 px-6">
                                                        @if ( $solicitud->status == 0)
                                                                <span class="bg-red-500 px-2 rounded-xl text-white text-xs">No Iniciada</span>
                                                        @elseif ( $solicitud->status ==1)
                                                                <span class="bg-yellow-400 px-2 rounded-xl text-white text-xs">En&nbsp;Proceso</span>
                                                        ...
                                                        @elseif($solicitud->status == 3)
                                                                <span class="bg-gray-200 px-2 rounded-xl text-gray-900 text-xs">Suspendida</span>
                                                        @endif
                                                    </td>
                                                    <td class="px-6 py-4">
