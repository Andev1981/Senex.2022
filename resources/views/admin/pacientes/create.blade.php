                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-6">
                                ...
                                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                                    ...
                                    <li>
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                class="ml-1 text-sm font-medium text-gray-400 md:ml-2 dark:text-gray-500">Crear
                                                nuevo</span>
                                        </div>
                                    </li>
                        ...
                        <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-6">
                            ...
                            <div class="relative z-0 mb-6 w-full group hidden">
                                <input type="password" name="password" id="password" value="paciente"
                            ...
                            <div class="grid xl:grid-cols-2 xl:gap-6">
                                ...
                                <button type="submit"
                                    class="text-white bg-blue-700 hover:bg-blue-800 mt-5 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ">Crear
                                    Paciente</button>
                                {!! Form::close() !!}
                            </div>
                        </div>
