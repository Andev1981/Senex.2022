<button {{ $attributes->merge(['role'=>'status','disabled' => 'disabled','type' => 'button', 'class' => 'inline-flex
    items-center px-4 py-2 bg-sky-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase
    tracking-widest hover:bg-blue-800 active:bg-sky-600 focus:outline-none focus:border-gray-900 focus:ring
