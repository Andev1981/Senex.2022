...
interface DteStats {
  ...
  dte_distribution?: Array<{ name: string; value: number }>;
...
export default function Dashboard({ dte_stats }: { dte_stats: DteStats }) {
  const { auth } = usePage().props as any; // 👈 El truco es el "as any"
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-1">
                      ...
                      <span
                        className={`text-[9px] px-2 py-0.5 rounded-lg font-black uppercase tracking-widest ${appointment.type === "evaluacion"
                  ...
                  <div className="flex-shrink-0">
                    <span
                      className={`inline-flex items-center gap-2 px-4 py-2 rounded-2xl text-[9px] font-black uppercase tracking-widest ${appointment.status === "Completada"
                        ? "bg-green-50 text-green-600"
          ...
          <div className="p-8 bg-white border border-gray-100 shadow-sm rounded-[2.5rem]">
            ...
            <div className="space-y-4">
              {pendingPayments.map((payment) => (
                <div
                  key={payment.id}
                  className={`p-6 rounded-[2rem] border-2 transition-all cursor-pointer ${payment.overdue
              ...
              <tbody className="divide-y divide-gray-50">
                {recentPatients.map((patient) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-6">
                      <span
                        className={`inline-flex items-center px-4 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-widest ${patient.status === "Activo"
                          ? "bg-green-50 text-green-600"
