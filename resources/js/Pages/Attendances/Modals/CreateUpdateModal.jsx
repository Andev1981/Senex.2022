...
export default function CreateUpdateModal({
  ...
  const handleSubmit = () => {
    ...
    if (isEditing) {
      router.patch(
        `/attendances/${sessionData.session_id}/patch`,
        normalizedData,
        {
          onSuccess: () => {
      ...
      router.post(route("attendances.store"), normalizedData, {
        onSuccess: () => {
          setShowCreateSessionModal(false);
          setSessionData({});
        },
      ...
      <div className="p-2 space-y-2">
          ...
          <div className="p-4 border-2 border-gray-200 rounded-lg">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div>
                <SearchSelect
                  items={session_types}
                  value={sessionData.session_type_id}
                  onChange={(value) => {
              ...
              <div>
                ...
                <input
                  type="date"
                  value={fmtDateISO(sessionData.date) || ""}
                  onChange={(e) => {
                    setSessionData({
                      ...sessionData,
                      date: e.target.value,
              ...
              {!isEditing && (
                <div>
                  ...
                  <select
                    value={sessionData.status || "scheduled"}
                    onChange={(e) => {
                      setSessionData({
                        ...sessionData,
        ...
        {canEditPlanFields() && (
          <>
            {!isEditing &&
              ...
              (() => {
                ...
                const selectedPlan = plans.find(
                  (p) => p.id === sessionData.patient_plan_id
                );
                  ...
                  <div className="space-y-3">
                    {plans.length > 1 ? (
                      <div>
                        ...
                        <select
                          value={sessionData.patient_plan_id || ""}
                          onChange={(e) => {
                      ...
                      >
                        ...
                        <div className="grid grid-cols-3 gap-3 mb-3">
                          ...
                          >
                            <p className="text-xs text-gray-700">Disponibles</p>
                            <p
                        ...
                        >
                          <input
                            type="checkbox"
                            id="consume_plan"
                            checked={sessionData.consume_plan === true}
                            onChange={(e) => {
                              setSessionData({
                                ...sessionData,
                    ...
                    {!sessionData.consume_plan && plans.length > 0 && (
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-yellow-700 mt-1">
                              Esta sesión NO consumirá ningún plan y se cobrará
                              por separado
                            </p>
                          </div>
                        </div>
            ...
            {isEditing && sessionData.consume_plan && (
              <div className="p-4 border-2 border-indigo-200 rounded-lg bg-indigo-50">
                ...
                <div className="space-y-4">
                  <label className="flex items-center gap-3 p-3 bg-white border-2 border-indigo-200 rounded-lg cursor-pointer hover:border-indigo-400">
                    <input
                      type="checkbox"
                      checked={sessionData.consume_plan || false}
                      onChange={(e) =>
                        setSessionData({
                          ...sessionData,
                          consume_plan: e.target.checked,
                          patient_plan_id: e.target.checked
                            ? sessionData.patient_plan_id
                            : null,
                        })
                      }
                  ...
                  {sessionData.consume_plan && (
                    <div>
                      ...
                      >
                        ...
                        {patients
                          .find((p) => p.id === sessionData.patient_id)
