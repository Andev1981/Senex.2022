...
export default function Kpis({ kpis, filtros }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-6 mb-10 md:grid-cols-2 lg:grid-cols-4 animate-in fade-in slide-in-from-top-4 duration-700">
      {/* TOTAL ATENCIONES */}
      <div className="p-6 bg-white border border-gray-100 shadow-sm rounded-xl hover:scale-[1.02] transition-all duration-300 group border-b-4 border-b-brand-primary">
      ...
      {/* COMPLETADAS */}
      <div className="p-6 bg-white border border-gray-100 shadow-sm rounded-xl hover:scale-[1.02] transition-all duration-300 group border-b-4 border-b-green-500">
        <div className="flex items-center justify-between mb-4">
      ...
      {/* PENDIENTES */}
      <div className="p-6 bg-white border border-gray-100 shadow-sm rounded-xl hover:scale-[1.02] transition-all duration-300 group border-b-4 border-b-amber-400">
        <div className="flex items-center justify-between mb-4">
      ...
      {/* FINANZAS */}
      <div className="p-6 bg-white border border-gray-100 shadow-sm rounded-xl hover:scale-[1.02] transition-all duration-300 group border-b-4 border-b-purple-500">
        <div className="flex items-center justify-between mb-4">
