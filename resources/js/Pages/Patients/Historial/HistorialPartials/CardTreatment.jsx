          ...
          <div>
            <div className="flex flex-wrap items-center gap-2 mb-1">
              ...
              {treatment?.current_phase && (
                <span
                  className={`inline-block px-3 py-1 text-xs text-indigo-700 bg-indigo-100 border border-indigo-200 rounded-full ${
                    getCurrentPhaseConfig(treatment.current_phase).className
                  }`}
                >
                  {getCurrentPhaseConfig(treatment.current_phase).label}
                </span>
              )}
