    ...
    <div className="p-6 bg-white shadow-lg rounded-xl">
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
        <div className="p-3 rounded-lg bg-teal-50">
          ...
          <p className="text-xl font-bold text-teal-600">{patient.height} cm</p>
        </div>
        <div className="p-3 rounded-lg bg-teal-50">
          <p className="mb-1 text-sm text-gray-600">Peso</p>
          <p className="text-xl font-bold text-teal-600">{patient.weight} kg</p>
        </div>
        <div className="p-3 rounded-lg bg-teal-50">
          <p className="mb-1 text-sm text-gray-600">IMC</p>
          <p className="text-xl font-bold text-teal-600">{patient.bmi}</p>
        </div>
        <div>
          <p className="mb-1 text-sm text-gray-600">Lado Dominante</p>
          <p className="font-semibold text-gray-900">{patient.dominant_side}</p>
        </div>
