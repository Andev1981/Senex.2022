              ...
              >
                <div className="flex justify-between">
                  ...
                  <div>
                    <button
                      onClick={onClose}
                      className="px-2 py-1.5 border border-primary text-primary m-2 rounded-lg text-sm font-medium leading-4 bg-white hover:bg-blue-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
                    >
                      X
                    </button>
                  </div>
