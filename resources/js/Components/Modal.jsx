 ...
 * @param {string} props.maxWidth - Clase de ancho máximo (sm, md, lg, xl, 2xl...)
 */
          ...
          <div className="flex items-center justify-center min-h-full p-4 md:p-6">
            ...
            >
              ...
              >
                ...
                <div className={`flex-1 flex flex-col min-h-0 ${title ? 'p-8 overflow-y-auto custom-scrollbar' : 'p-0 overflow-hidden'}`}>
                    {children}
                </div>
